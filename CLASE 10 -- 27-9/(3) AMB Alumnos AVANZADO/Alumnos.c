...
void inicializarAlumnosConDatos (eAlumno listado[], int tam)
{
    ...
    int curso[5] = {101,102,101,100,102};
...
{
    printf("%d -- %s -- %s -- %f -- %d-%d-%d -- %d\n", alumnoParametro.legajo, alumnoParametro.nombre, alumnoParametro.direccion, alumnoParametro.promedio, alumnoParametro.fechaNacimiento.dia, alumnoParametro.fechaNacimiento.mes, alumnoParametro.fechaNacimiento.anio, alumnoParametro.idCurso);
}
